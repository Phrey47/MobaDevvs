...
5. **Account Settings Group** — Grouped card section with: Account info row (person icon), Notifications toggle (bell icon, shown ON), and Download/offline toggle (download icon).
...
| ICN-01 | Icon | Arrow (›) | Right arrow beside app name row — decorative or tappable for about |
| ICN-02 | Icon | Font Icon (T) | Visual indicator for the font size setting row |
...
| ICN-03 | Icon | Theme / Display Icon | Visual indicator for the theme/display mode setting row |
...
| ICN-04 | Icon | Language / Globe Icon | Visual indicator for the Bible translation setting row |
...
| ICN-05 | Icon | Person Icon | Visual indicator for the account settings row |
| TXT-06 | Text | Account Label | Labels the account settings row |
| ICN-06 | Icon | Bell Icon | Visual indicator for the notifications setting row |
| TXT-07 | Text | Notifications Label | Labels the notifications on/off setting row |
| TGL-02 | Toggle | Notifications Toggle | Turns push notifications ON or OFF (wireframe shows ON) |
| ICN-07 | Icon | Download Icon | Visual indicator for the offline/download setting row |
| TXT-08 | Text | Download Label | Labels the offline Bible content download setting row |
| CTL-03 | Control | Download Selector | Manages offline Bible content downloads per translation |
| ICN-08 | Icon | Info Circle Icon | Visual indicator for the About app row |
| TXT-09 | Text | About Label | Labels the about or app information row |
